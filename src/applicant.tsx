    ...
    <div className="space-y-8">
      ...
      <div className="paper-card p-6">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <DetailField label="Evidence completion" value={`${app.evidenceCompletionPct}%`} />
      ...
      {app.assessment?.status === "insufficient_evidence" && (
        <Alert>
          <AlertTriangle className="h-4 w-4" />
          <AlertTitle>Not enough evidence yet for a risk assessment</AlertTitle>
          <AlertDescription>
            ...
            {app.assessment.missingDocumentTypes.length > 0 && (
              <p className="mt-2">
                Consider uploading: <span className="font-medium">{app.assessment.missingDocumentTypes.join(", ")}</span>
              </p>
            )}
          </AlertDescription>
        </Alert>
